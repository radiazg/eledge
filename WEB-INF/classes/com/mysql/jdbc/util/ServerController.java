 ...
 *
 * @version $Id: ServerController.java,v 1.1.2.2 2003/04/17 14:49:18 mmatthew Exp $
...
public class ServerController {
	...
	private boolean runningOnWindows() {
		return getSystemProperties().getProperty("os.name").toUpperCase().indexOf("WINDOWS") != -1;
	}
}
