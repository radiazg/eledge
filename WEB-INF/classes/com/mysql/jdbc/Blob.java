 ...
 * 
 * @version $Id: Blob.java,v 1.9.4.3 2004/01/20 22:50:50 mmatthew Exp $
 */
public class Blob
    ...
    Blob(byte[] data, ResultSet creatorResultSetToSet, int columnIndexToSet) {
        ...
        this.columnIndex = columnIndexToSet;
    }
    ...
    private void setBinaryData(byte[] binaryDataToSet) {
        this.binaryData = binaryDataToSet;
    }
